...
import com.rag.testapp5.databinding.ActivityShowDetailBinding;
...
//        setContentView(R.layout.activity_show_detail);
    ...
    private void getBundle() {
        ...
        binding.detailViewPrice.setText("$ " + object.getFee());
        descriptionTxt.setText(object.getDescription());
        numberOrderTxt.setText(String.valueOf(numberOrder));
        caloryTxt.setText(String.valueOf(object.getCalories()));
        starTxt.setText(String.valueOf(object.getStar()));
        timeTxt.setText(String.valueOf(object.getTime() )+ " minutes");
        totalPriceText.setText("$ " +String.valueOf(numberOrder * object.getFee()));
        ...
        binding.detailPlusQtyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                totalPriceText.setText("$ " +decfor.format(numberOrder * object.getFee()));
